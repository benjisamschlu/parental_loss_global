...
\hypersetup{
  pdftitle={Parental loss: A global perspective},
  colorlinks=true,
  linkcolor={blue},
  filecolor={Maroon},
  citecolor={blue},
...
\title{Parental loss: A global perspective}
...
Period \emph{life table data} by 1-year age class (0, 1, 2, \ldots, 100+) and sex, grouped in one calendar year were obtained from the UNWPP (\protect\hyperlink{ref-united2022world}{United Nations 2022}). All the life table functions (e.g.~age-specific probabilities of dying and surviving) were retrieved from this data source. Yearly age-specific \emph{fertilty rates} for females aged 15 to 49 years old and \emph{population counts} by 1-year age group and sex were also obtained from this source.
